...
const PORTFOLIO_DATA = {
  // Profile Section
  profileImage:
    "https://images.unsplash.com/photo-1719400471588-575b23e27bd7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBkZXZlbG9wZXIlMjB3b3Jrc3BhY2V8ZW58MXx8fHwxNzY4NDE2NjU1fDA&ixlib=rb-4.1.0&q=80&w=1080",
  name: "Your Name",

  // Social Links
  discord: {
    username: "YourDiscord#0000",
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            {PORTFOLIO_DATA.work.map((project, index) => (
              <div
                key={index}
                className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 flex flex-col lg:flex-row gap-6"
              >
                {/* Video */}
